...
單檔 **HTML + Tailwind CDN** 網頁產生器,內建 **10 款策展風格**(預設 = 編輯/手札風:暖紙 + 深藏青 + 金棕襯線)。每款共用同一套引擎:淺/深/系統主題、繁中 / English i18n、RWD 貼邊寬版、主色/背景設定、**右下角浮動 AI 聊天助理**(BYOK 自帶金鑰・Gemini / OpenAI / Claude)、一鍵匯出乾淨 HTML。
